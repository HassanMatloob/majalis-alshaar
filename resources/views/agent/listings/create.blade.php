...
@section('title', 'Agency - Add Listing')
...
<form action="{{ route('agent.listing.store') }}" method="post">
    @csrf
    <section class="flex justify-between items-center">
        <div class="flex gap-2 items-center">
            ...
            <h1 class="text-3xl font-semibold text-[#575757]">Add Listing</h1>
        </div>
                        ...
                        <div class="w-full">
                            <div>
                                ...
                                <div class="grid xl:grid-cols-2 2xl:grid-cols-3 mt-2 gap-4">
                                    <div>
                                        <div class="w-full p-5 bg-[#F2F2F2] h-[99px]">
                                            ...
                                            <input type="text" name="country" id="country" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" placeholder="country" required>
                                        </div>
                                        @error('country')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <div class="w-full p-5 bg-[#F2F2F2] h-[99px]">
                                            ...
                                            <input type="text" name="state" id="state" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" placeholder="state" required>
                                        </div>
                                        @error('state')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <div class="w-full p-5 bg-[#F2F2F2] h-[99px]">
                                            ...
                                            <input type="text" name="city" id="city" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" placeholder="city" required>
                                        </div>
                                        @error('city')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="w-full p-4 bg-[#F2F2F2]  h-[99px] mt-3">
                                    ...
                                    <input id="address" name="property_location" type="text" placeholder="address" class="w-full mt-2 text-[#575757] font-normal  focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                                </div>
                                ...
                                <div class="grid xl:grid-cols-2 2xl:grid-cols-4 mt-2 gap-4">
                                    <div>
                                        <div class="w-full p-4 bg-[#F2F2F2]  h-[99px]">
                                            ...
                                            <input id="bedrooms" name="bedrooms" type="number" placeholder="0" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                                        </div>
                                        @error('bedrooms')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <div class="w-full p-4 bg-[#F2F2F2]  h-[99px]">
                                            ...
                                            <input id="bathrooms" name="bathrooms" type="number" placeholder="0" class="w-full mt-2 text-[#575757] font-normal  focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                                        </div>
                                        @error('bathrooms')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <div class="w-full p-4 bg-[#F2F2F2]  h-[99px]">
                                            ...
                                            <input id="floors" name="floors" type="number" placeholder="0" class="w-full mt-2 text-[#575757] font-normal  focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                                        </div>
                                        @error('floors')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <div class="w-full p-4 bg-[#F2F2F2]  h-[99px]">
                                            ...
                                            <input id="area" name="area" type="number" placeholder="0.00" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" step="0.01" required>
                                        </div>
                                        @error('area')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="grid xl:grid-cols-2 2xl:grid-cols-3 mt-2 gap-4">
                                    <div>
                                        <div class="w-full p-4 bg-[#F2F2F2]  h-[99px]">
                                            ...
                                            <input id="price" name="price" type="number" placeholder="0 - AED" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" step="0.01" required>
                                        </div>
                                        @error('price')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
