...
@section('title', 'Agency - Management - Agents - Add')
...
@endsession
<form action="{{ route('agency.management.agent.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <section class="flex justify-between items-center">
        <div class="flex gap-2 items-center">
            ...
            <h1 class="text-3xl font-semibold text-[#575757]">Add Agent</h1>
        </div>
        <button type="submit" class="px-8 py-2 text-base font-semibold bg-primary hover:bg-primaryHover  text-white rounded-lg">Save</button>
    </section>
    <section class="mt-16">
            ...
            <div class="col-span-8">
                ...
                <div class="rounded-lg p-10 bg-white">
                    <div class="w-full p-4 bg-[#F2F2F2]  h-[99px]">
                        ...
                        <input id="name" type="text" name="name" placeholder="Add agent name here" class="w-full mt-2 text-[#575757] font-normal  focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                    </div>
                    @error('name')
                    ...
                    <div class="w-full p-4 bg-[#F2F2F2]  h-[99px] mt-7">
                        ...
                        <input id="phone" type="number" name="phone" placeholder="phone number" class="w-full mt-2 text-[#575757] font-normal  focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                    </div>
                    @error('phone')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                    <div class="w-full p-4 bg-[#F2F2F2]  h-[99px] mt-7">
                        ...
                        <input id="email" type="text" name="email" placeholder="email" class="w-full mt-2 text-[#575757] font-normal  focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                    </div>
                    @error('email')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="w-full p-4 bg-[#F2F2F2] mt-7">
                        ...
                        <div class="border-2 border-dashed border-[#d3d3d3] py-10 justify-center w-full flex flex-col items-center rounded-xl mt-6 bg-white">
                            ...
                            <input type="file" id="imageUpload" name="photo" accept="image/png, image/jpeg, image/jpg" class="pl-[190px] pt-4" required>
