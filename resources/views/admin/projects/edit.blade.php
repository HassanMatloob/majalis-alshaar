...
<form action="{{ route('admin.projects.update', $project) }}" method="post">
    ...
    <section class="flex justify-between items-center">
        <div class="flex gap-2 items-center">
            ...
            <h1 class="text-3xl font-semibold text-[#575757]">Edit Project</h1>
        </div>
            ...
            <div class="col-span-8">
                ...
                <div class="rounded-lg p-10 bg-white">
                    <div class="w-full p-4 bg-[#F2F2F2]  h-[99px]">
                        ...
                        <input id="title" name="title" type="text" placeholder="Add listing title here" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" value="{{ $project->title }}" required>
                    </div>
                    @error('title')
                    ...
                    <div class="w-full p-4 bg-[#F2F2F2]  h-[99px] mt-4">
                        ...
                        <input id="title" name="arabic_title" type="text" placeholder="Add listing arabic title here" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" value="{{ $project->arabic_title }}" required>
                    </div>
                    @error('arabic_title')
                    <span class="text-red-500">{{ $message }}</span>
                    @enderror
                    <div class="w-full p-4 bg-[#F2F2F2]  h-[161px] mt-4">
                        ...
                        <textarea name="short_description" id="short_description" cols="30" rows="4" placeholder="This will show on listings page" class="w-full mt-2 text-[#575757] font-normal -none  focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]">{{ $project->short_description }}</textarea>
                    </div>
                    ...
                    <div class="w-full p-4 bg-[#F2F2F2]  h-[161px] mt-4">
                        ...
                        <textarea name="arabic_short_description" id="short_description" cols="30" rows="4" placeholder="This will show on listings page" class="w-full mt-2 text-[#575757] font-normal -none  focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]">{{ $project->arabic_short_description }}</textarea>
                    </div>
                    ...
                    <div class="w-full p-4 bg-[#F2F2F2]  h-[280px] mt-4">
                        ...
                        <x-quill-editor id="description" name="description" placeholder="Please type the porperty description ..." value="{!! $project->description !!}" />
                    </div>
                    @error('description')
                    <span class="text-red-500">{{ $message }}</span>
                    @enderror
                    <div class="w-full p-4 bg-[#F2F2F2]  h-[280px] mt-4">
                        ...
                        <x-quill-editor id="arabic_description" name="arabic_description" placeholder="Please type the porperty arabic description ..." value="{!! $project->arabic_description !!}" />
                    </div>
                        ...
                        <div class="w-full">
                            <div>
                                ...
                                <div class="grid xl:grid-cols-2 2xl:grid-cols-3 mt-2 gap-4">
                                    <div>
                                        <div class="w-full p-5 bg-[#F2F2F2] h-[99px]">
                                            ...
                                            <input type="text" name="country" id="country" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" placeholder="country" value="{{ $project->country }}" required>
                                        </div>
                                        @error('country')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <div class="w-full p-5 bg-[#F2F2F2] h-[99px]">
                                            ...
                                            <input type="text" name="province" id="province" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" placeholder="province" value="{{ $project->province }}"  required>
                                        </div>
                                        @error('province')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <div class="w-full p-5 bg-[#F2F2F2] h-[99px]">
                                            ...
                                            <input type="text" name="city" id="city" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" placeholder="city" value="{{ $project->city }}"  required>
                                        </div>
                                        @error('city')
                                        <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <div class="w-full p-5 bg-[#F2F2F2]  h-[99px]">
                                            ...
                                            <input id="address" name="property_location" type="text" placeholder="address" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:-transparent placeholder-gray-400 bg-[#F2F2F2]" value="{{ $project->property_location }}"  required>
                                        </div>
                                ...
                                <div class="w-full p-5 mt-4 bg-[#F2F2F2]">
                                    ...
                                    <input id="tags" name="tags" type="text" value="{{implode(', ', $project->tags)}}"
            ...
            <div class="col-span-4 bg-white rounded-lg px-7 py-10 h-[437px]">
                ...
                <div class="w-full p-5 bg-[#F2F2F2]  h-[99px] mt-7">
                    ...
                    <select name="status" id="status" class="w-full mt-2 text-[#575757] font-normal focus:outline-none focus:border-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                        ...
                        <option value="0" {{ !$project->status ? 'selected' : '' }}>Inacitve</option>
                    </select>
                </div>
                @error('type')
                <span class="text-red-500">{{ $message }}</span>
