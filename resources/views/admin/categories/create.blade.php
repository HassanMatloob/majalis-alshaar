...
<form action="{{ route('admin.categories.store') }}" method="POST">
    ...
    <section class="flex justify-between items-center">
        <div class="flex gap-2 items-center">
            ...
            <h1 class="text-4xl font-semibold text-[#575757]">Add New Category</h1>
        </div>
        <button class="px-8 py-2 text-base font-semibold bg-primary hover:bg-primaryHover  text-white rounded-lg">Save</a>
    </section>
            ...
            <div class="xl:col-span-8 col-span-12 p-10 bg-white">
                <div class="grid grid-cols-2 gap-7">
                    <div class="w-full p-4 bg-[#F2F2F2] border h-[99px]">
                        ...
                        <input id="name" name="name" type="text" placeholder="category name" class="w-full mt-2 text-black font-normal  focus:outline-none focus:border-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                        @error('name')
                    ...
                    <div class="w-full p-4 bg-[#F2F2F2] border h-[99px]">
                        ...
                        <input id="arabic_name" name="arabic_name" type="text" placeholder="category arabic name" class="w-full mt-2 text-black font-normal  focus:outline-none focus:border-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                        @error('arabic_name')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="w-full p-4 bg-[#F2F2F2] border h-[99px]">
                        ...
                        <input id="order" name="order" type="number" placeholder="order" class="w-full mt-2 text-black font-normal focus:outline-none focus:border-transparent placeholder-gray-400 bg-[#F2F2F2]" required>
                        @error('order')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
